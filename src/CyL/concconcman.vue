    ...
    <div>
        ...
        <v-card>
            ...
            <v-toolbar flat color="white">
                    <v-toolbar-title class="rdmqc">Conciliación Manual Medios de Pago</v-toolbar-title>
                </v-toolbar>
                            ...
                            <v-expansion-panel-content>
                                <v-container>
                                    ...
                                    <v-row>
                                        ...
                                        <v-switch class="mr-2 switch-small" v-model="ctEmisorFilterValue" label="Emisor" color="info" true-value="true" false-value="false" hide-details></v-switch>
                                        </v-col>

                                        <!-- CRITERIOS FECHA -->
                                        <v-col cols="12" xs="12" sm="12" md="6" lg="1" xl="1">
                                        <v-switch class="mr-2 switch-small" dense v-model="ctFechaFilterValue" label="Fecha" color="info" true-value="true" false-value="false" hide-details></v-switch>
                                        </v-col>

                                        <!-- CRITERIOS DIAS -->
                                        <v-col cols="12" xs="12" sm="12" md="6" lg="4" xl="4" class="d-flex align-center">
                                            <v-switch v-model="ctDiasFilterValue" label="± X-días" color="info" class="mr-2 switch-small" dense></v-switch>
                                            <v-select class="my-custom-select" :items="dias" v-model="diaFilterValue" solo dense></v-select>
                                        </v-col>

                                        <!-- CRITERIOS LOCAL -->
                                        <v-col cols="12" xs="12" sm="12" md="6" lg="1" xl="1">
                                        <v-switch class="mr-2 switch-small" v-model="ctLocalFilterValue" label="Local" color="info" true-value="true" false-value="false" hide-details></v-switch>
                                        </v-col>

                                        <!-- CRITERIOS MONTO -->
                                        <v-col cols="12" xs="12" sm="12" md="6" lg="1" xl="1">
                                        <v-switch class="mr-2 switch-small" v-model="ctMontoFilterValue" label="Monto" color="info" true-value="true" false-value="false" hide-details></v-switch>
                                        </v-col>

                                        <!-- CRITERIOS NUMERO TARJETA -->
                                        <v-col cols="12" xs="12" sm="12" md="6" lg="2" xl="2">
                                        <v-switch class="mr-2 switch-small" v-model="ctNumTarjetaFilterValue" label="N° Tarjeta" color="info" true-value="true" false-value="false" hide-details></v-switch>
                                        </v-col>

                                        <!-- CRITERIOS Cod. Autorización -->
                                        <v-col cols="12" xs="12" sm="12" md="6" lg="2" xl="2">
                                        <v-switch class="mr-2 switch-small" v-model="ctCodAutorizacionFilterValue" label="Cod. Aut." color="info" true-value="true" false-value="false" hide-details></v-switch>
                                        </v-col>
...
import { getCadenas, getLocales, getLocalesByCadena, getEmisores, getTipoTrxByEmisor, 
    getDetalleConciliacionManualByFiltro, updateEstadoConciliacionTrx } from '../services/ConcconcmanService';
import Vue from 'vue';
...
export default {
    ...
    async mounted() {
        ...
        this.diaFilterValue = this.dias[0];
        this.loader = false;
    },
    ...
    methods: {
        ...
        async detalleByFiltro() {
            this.desserts = [];
            this.selected = [];
            this.duplicadasSeleccionadas = [];
            this.desconocidasSeleccionadas = [];
            ...
            // VALIDACIONES
                ...
                if (this.startDate && this.endDate && this.emisorFilterValue && this.cadenaFilterValue) {
                    ...
                    if (this.ctDiasFilterValue == "" || this.ctDiasFilterValue == null) {
                        this.ctDiasFilterValue = false;
                    }
                    ...
                    const filtro = {
                        ...
                        ct_1dia: this.ctDiasFilterValue,
                        qtydia: this.diaFilterValue,
                ...
                if (this.desserts.length > 0) {
                    ...
                    this.desserts.forEach((objDesserts) => {
                        ...
                        let dataDesconocida = objDesserts.des.map(row => ({
                            'Fecha': row.trx_fecha.split('T')[0].split('-').reverse().join('-'),
        ...
        async showDialogConciliacionManual() {
            ...
            for (let index = 0; index < this.desserts.length; index++) {
                ...
                if (objDuplicadaSeleccionada.length > 0 && objDesconocidaSeleccionada.length > 0) {
...
.switch-small .v-input__control {
  transform: scale(0.6);
}

.my-custom-select .v-input__slot {
  /* Ajusta la altura del v-select */
  min-height: 36px;
}

.my-custom-select .v-select__slot {
  /* Ajusta el padding y la altura de la caja del select */
  padding-top: 0;
  padding-bottom: 0;
  height: 36px;
}

/* Aumenta la especificidad para el contenido del menú */
.my-custom-select >>> .v-menu__content {
  /* Ajusta el ancho del menú */
  max-width: 200px;
}

/* Aumenta la especificidad para las opciones del select */
.my-custom-select >>> .v-list-item {
  /* Ajusta el padding y la altura de las opciones */
  padding: 4px 16px;
  min-height: 32px;
}
